...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/future_typing-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13413&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/future_typing-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `future_typing` can be installed with:

```
conda install future_typing
```

It is possible to list all of the versions of `future_typing` available on your platform with:
